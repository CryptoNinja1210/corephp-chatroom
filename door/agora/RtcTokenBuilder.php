...
class RtcTokenBuilder
{
    ...
    public static function buildTokenWithUid($appID, $appCert, $channelName, $uid, $role, $privilegeExpireTs){
        return RtcTokenBuilder::buildTokenWithUserAccount($appID, $appCert, $channelName, $uid, $role, $privilegeExpireTs);
    }
