                        ...
                        if (isset($arg[1]['visibility']) && $nmchk[0]['v3'] != $arg[1]['visibility']) {
                            ...
                            if (!empty($arg[1]['visibility'])) {
                                if ($arg[1]['visibility'] == '2') {
                                    ...
                                    gr_data('u', 'v7', 'type,id', $credit, 'group', $arg[1]['id']);
                                } 
                                else{
                    ...
                    foreach ($lists as $f) {
                        ...
                        if (empty($arg[1][$pf]) && $f['req'] == 1 || empty($arg[1][$pf]) && $f['req'] == 3) {
                            ...
                            if ($ct == 0) {
                                ...
                                if($f['id'] == '6') {
                                    $_query = "SELECT * FROM `gr_country` WHERE countryname = '" . $arg[1][$pf] . "'";
                                    $_result = db('Grupo', 'q', $_query);
                                    $newCode = "";
                                    if(count($_result) > 0) {
                                        $newCode = $_result[0]['code'];
                                    }

                                    $_query = "UPDATE `gr_profiles` SET v1 = '" . $arg[1][$pf] . "', v2 = '" . $newCode . "' WHERE uid = " . $arg[1]['id'] . " AND type = 'profile' AND name = '6'";
                                    db('Grupo', 'q', $_query);
                                } else {
